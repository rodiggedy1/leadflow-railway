...
- [x] Apply a presentation-only MIB Command visual layer to the live Command Chat, preserving existing data, actions, and handlers; validate before preview deployment.
