...
describe("MIB dashboard router contract", () => {
  ...
  it("stays read-only and independent of alternate schedule storage", () => {
    for (const prohibited of [".insert(", ".update(", ".delete(", "cleanerJobs", "cleaner_jobs", "scheduleAssignments", "schedulingTeams"]) {
