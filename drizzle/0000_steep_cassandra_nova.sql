...
--> statement-breakpoint
CREATE TABLE `gmail_thread_cache` (
	`threadId` varchar(255) NOT NULL,
	`fromName` varchar(512) NOT NULL DEFAULT '',
	`fromEmail` varchar(512) NOT NULL DEFAULT '',
	...
	`needsRefresh` int NOT NULL DEFAULT 0,
	`cachedAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `gmail_thread_cache_threadId` PRIMARY KEY(`threadId`)
);
--> statement-breakpoint
