...
// ── Customer Portal — a customer-owned portal separate from staff, agent, and cleaner access ──
export const customerPortalAccounts = mysqlTable("customer_portal_accounts", {
  ...
  uniqueIndex("uq_customer_portal_account_phone").on(t.customerPhone),
  index("idx_customer_portal_account_email").on(t.customerEmail),
]);
...
export const customerPortalHandoffTokens = mysqlTable("customer_portal_handoff_tokens", {
  ...
  uniqueIndex("uq_customer_portal_handoff_hash").on(t.tokenHash),
  index("idx_customer_portal_handoff_account").on(t.accountId),
  index("idx_customer_portal_handoff_expiry").on(t.expiresAt),
]);
...
export const customerPortalServiceRequests = mysqlTable("customer_portal_service_requests", {
  ...
  uniqueIndex("uq_customer_portal_service_request_number").on(t.publicRequestNumber),
  index("idx_customer_portal_service_request_account").on(t.accountId, t.createdAt),
  index("idx_customer_portal_service_request_schedule").on(t.requestedLocalDate, t.status),
]);
export type CustomerPortalServiceRequest = typeof customerPortalServiceRequests.$inferSelect;
