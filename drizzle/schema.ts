...
export const cardAuthTokens = mysqlTable("card_auth_tokens", {
  ...
  cleanerJobId: int("cleanerJobId"),
  nativeBookingId: int("nativeBookingId"),
  used: tinyint("used").notNull().default(0),
...
export const bookings = mysqlTable("bookings", {
  ...
  funnelStage: varchar("funnelStage", { length: 32 }).notNull().default("lead"),
  ...
  stripeCardAuthToken: varchar("stripeCardAuthToken", { length: 64 }),
  stripeCustomerId: varchar("stripeCustomerId", { length: 255 }),
