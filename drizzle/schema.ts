...
export const cleanerPortalJobProgress = mysqlTable("cleaner_portal_job_progress", {
  ...
  arrivalSmsClaimedAt: datetime("arrivalSmsClaimedAt", { mode: "date", fsp: 3 }),
  arrivalSmsSentAt: datetime("arrivalSmsSentAt", { mode: "date", fsp: 3 }),
  arrivalSmsMessageId: varchar("arrivalSmsMessageId", { length: 128 }),
  arrivalSmsError: text("arrivalSmsError"),
  etaSmsClaimedMinutes: int("etaSmsClaimedMinutes"),
  etaSmsSentMinutes: int("etaSmsSentMinutes"),
  etaSmsMessageId: varchar("etaSmsMessageId", { length: 128 }),
  etaSmsError: text("etaSmsError"),
