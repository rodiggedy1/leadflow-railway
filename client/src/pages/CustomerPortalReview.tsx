...
export default function CustomerPortalReview() {
  ...
  return <main className="mib-review-page"><div className="mib-review-shell">
    <header className="mib-review-hero"><div className="mib-review-hero-copy"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663254023424/LKsoKRkIleBYVKgh.png" alt="Maids in Black" /><h1>Thanks for having<br />us today!</h1><p>We hope you love your clean.</p></div><div className="mib-review-photo"><img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663254023424/sDqgYgSwvYbZYYSn.png" alt="A Maids in Black cleaner at work" /></div></header>
