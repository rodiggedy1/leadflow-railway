    ...
    {isPanel ? (
      <>
        ...
        <section className="mib-booking-panel__intro">
          ...
          <h1>{step === 1 ? "Build your cleaning." : step === 2 ? "Choose your time." : step === 3 ? "Almost there." : portalRebook?.savedCard ? "Finalizing your appointment." : "Secure your appointment."}</h1>
          <p>{step === 1 ? "Choose what you need. Your price updates instantly." : step === 2 ? "Choose the day and arrival window that works for you." : step === 3 ? "We’ll use this information for confirmation and arrival updates." : portalRebook?.savedCard ? "Your saved card is securely on file. You won’t be charged today." : "Add a card to reserve your cleaning. You won’t be charged today."}</p>
