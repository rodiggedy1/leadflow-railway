...
const EMBER = "#E8651A";
const TEAM_PHOTO = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663254023424/PyBlctAZLtYAyuLX.webp";
    ...
    <div className="min-h-screen font-sans" style={{ backgroundColor: "#010202", color: "#f1eeeb" }}>
      ...
      <section className="relative w-full bg-black">
        <div className="relative mx-auto" style={{ maxWidth: "1100px" }}>
          ...
          <div className="absolute bottom-0 left-0 right-0 z-20 text-center px-4 translate-y-[80px]">
