...
export default function OpsChat({ onMinimize, onClose, initialTab: initialTabProp }: OpsChatProps = {}) {
  console.count("[RENDER] OpsChat"); console.log("[RENDER-TS] OpsChat", performance.now().toFixed(1));
  ...
  // STAGE-1 DIAGNOSTIC: commandMsgsForSound temporarily disabled to test freeze causation.
  // Restore: change `enabled: false` back to `enabled: isAuthenticated, refetchInterval: 15_000`
