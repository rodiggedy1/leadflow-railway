...
const en = {
  translation: {
    ...
    "v2.nav.arrivedConfirmHeading": "⚠️ ARE YOU AT THE DOOR?",
    "v2.nav.arrivedConfirmBody": "DO NOT tap Arrived until you are standing at the customer's door.",
    "v2.nav.arrivedConfirmWarning": "Tapping this button will immediately send a message to the client.",
    "v2.nav.arrivedConfirmYes": "Yes, I'm at the door",
    "v2.nav.arrivedConfirmNo": "Not yet — go back",
...
const es = {
  translation: {
    ...
    "v2.nav.arrivedConfirmHeading": "⚠️ ¿ESTÁS EN LA PUERTA?",
    "v2.nav.arrivedConfirmBody": "NO toques Llegué hasta que estés parado en la puerta del cliente.",
    "v2.nav.arrivedConfirmWarning": "Al tocar este botón se enviará inmediatamente un mensaje al cliente.",
    "v2.nav.arrivedConfirmYes": "Sí, estoy en la puerta",
    "v2.nav.arrivedConfirmNo": "Todavía no — volver",
...
const pt = {
  translation: {
    ...
    "v2.nav.arrivedConfirmHeading": "⚠️ VOCÊ ESTÁ NA PORTA?",
    "v2.nav.arrivedConfirmBody": "NÃO toque em Cheguei até estar na porta do cliente.",
    "v2.nav.arrivedConfirmWarning": "Tocar este botão enviará imediatamente uma mensagem ao cliente.",
    "v2.nav.arrivedConfirmYes": "Sim, estou na porta",
    "v2.nav.arrivedConfirmNo": "Ainda não — voltar",
