...
const NAV_GROUPS: Array<{ label: string; items: ReviewDestination[] }> = [
  ...
  { label: "TEAM OPERATIONS", items: [{ label: "Team", href: "/review/team", icon: UsersRound }, { label: "Reviews & Quality", href: "/review/reviews-quality", icon: Star }, { label: "Payroll Summary", href: "/review/payroll-summary", liveHref: "/admin/payroll-summary", icon: WalletCards }, { label: "Hiring Admin", href: "/review/hiring-admin", icon: UserRoundCheck }] },
];
