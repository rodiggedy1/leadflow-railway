            ...
            <>
              ...
              <form onSubmit={handleFormNext} noValidate>
                ...
                <div className="animate-fade-slide-up delay-6 mt-6 mb-2">
                  ...
                  {/* Testimonial */}
                  <div className="text-center mb-6">
                    <p className="text-base sm:text-lg leading-relaxed mb-5" style={{ color: "#3A2A20", fontFamily: "'Playfair Display', serif" }}>
                      &ldquo;I used to spend weekends cleaning and still felt behind.{" "}
                      <strong>Now I come home to a spotless house every week.</strong>{" "}
