/**
 * ObjectionsPanel — slide-up panel for CS Chat.
 * Shows 8 preset objection cards + a manual input field.
 * Clicking a card or submitting a custom objection calls the AI
 * and returns a high-converting rebuttal script.
 */
      ...
      <div className="flex-1 overflow-y-auto min-h-0 px-4 py-3 space-y-3">
        {!hasConversation ? (
          ...
          <div className="space-y-3">
            ...
            {/* Quick follow-up presets after first answer */}
